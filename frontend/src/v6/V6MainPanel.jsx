 ...
 * everything else too.
 */
export default function V6MainPanel({ step, wallet, treasury, explorer, reload, report, locked, backupCount }) {
  ...
  return (
    <Step {...step}>
      ...
      {wallet ? (
        ...
        <div className="row">
          <Busy
            ...
            onClick={() =>
              act('generate', () =>
                api('/v6/wallets/generate', 'POST', { count: 1, role: ROLES.main, label: 'v6 main' })
              )
            }
          >
      ...
      <Modal
        ...
        onConfirm={async () => {
          await act('fund', () => api('/v6/fund', 'POST', { amountEth: amount.trim() }));
          setAmount('');
          setFunding(false);
        }}
      >
