 ...
 * everything else too.
 */
export default function V7MainPanel({ step, wallet, treasury, explorer, reload, report, locked, backupCount }) {
  ...
  return (
    <Step {...step}>
      ...
      {wallet ? (
        ...
        <div className="row">
          <Busy
            ...
            onClick={() =>
              act('generate', () =>
                api('/v7/wallets/generate', 'POST', { count: 1, role: ROLES.main, label: 'v7 main' })
              )
            }
          >
      ...
      <Modal
        ...
        onConfirm={async () => {
          await act('fund', () => api('/v7/fund', 'POST', { amountEth: amount.trim() }));
          setAmount('');
          setFunding(false);
        }}
      >
